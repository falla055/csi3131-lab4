...
class MemManageExp
{
   public static void main(String[] args)
   {
       ...
       // Use Working Set page replacement algorithm
       System.out.println("Running simulation using WORKING_SET");
       ...
       // Use Working Set page replacement algorithm
       System.out.println("Running simulation using RANDOM");
       mmng = new MemManage(PagingAlgorithm.RANDOM,startTime,endTime,sds);
       mmng.runSimulation();
       mmng.computeOutput();
       System.out.println("Number of faults: "+mmng.phiTimeBtwFaults.number);
       System.out.println("Number memory accesses (no faults): "+mmng.numMemAccesses);
